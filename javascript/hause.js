...
const searchImages = () => {
    ...
    getImages(`https://api.pexels.com/v1/search?query=hause&page=${currentPage}&per_page=${perPage}`);
};
...
const loadMoreImages = () => {
    currentPage++;
    let apiUrl = `https://api.pexels.com/v1/search?query=hause&page=${currentPage}&per_page=${perPage}`;
    apiUrl = searchTerm ? `https://api.pexels.com/v1/search?query=hause&page=${currentPage}&per_page=${perPage}` : apiUrl;
    getImages(apiUrl);
}
